$(document).ready(function(){
	var noop = function() {};
	var dustycanvas = document.getElementById("dustycanvas");
	...
	//	var dustycanvas = document.getElementById("dustycanvas");
		var context = dustycanvas.getContext("2d");
		var displayWidth;
		var displayHeight;
		var timer;
		var wait;
		...
		function init() {
			...
			var blockstyle = getComputedStyle(introRight);
			var width = parseInt(blockstyle.getPropertyValue('width'), 10);
			blockstyle = getComputedStyle(introLeft);
			var height = parseInt(blockstyle.getPropertyValue('height'), 10);
			dustycanvas.width = width;
			dustycanvas.height = height;
			wait = 1;
			count = wait - 1;
			numToAddEachFrame = 8;
			...
			*/
			...
			sphereCenterX = 0;
			sphereCenterY = 0;
			sphereCenterZ = -30 - sphereRad;
			//alpha values will lessen as particles move further back, causing depth-based darkening:
			zeroAlphaDepth = -3000; //-750
