if (function(e, t) {
    ...
    mn = En.exec(yn.toLowerCase()) || [], x.fn.load = function(e, n, r) {
      ...
      ajax: function(e, n) {
        ...
        function k(e, n, r, i) {
          var c, y, v, w, T, N = n;
          2 !== b && (b = 2, s && clearTimeout(s), u = t, a = i || "", C.readyState = 0 < e ? 4 : 0, c = 200 <= e && e < 300 || 304 === e, r && (w = function(e, n, r) {
    ...
    x.ajaxSettings.xhr = e.ActiveXObject ? function() {
      return !this.isLocal && In() || function() {
        try {
    ...
    if (/(38|40|27)/.test(b.keyCode)) {
      ...
      if (b.preventDefault(), b.stopPropagation(), !d.is(".disabled, :disabled")) {
        ...
        if (i.length) {
          ...
          38 == b.keyCode && 0 < j && j--, 40 == b.keyCode && j < i.length - 1 && j++, ~j || (j = 0), i.eq(j).focus()
        }
      }
    }
  };
...
function(a) {
  ...
  function(f, g, k) {
    var l = {
      ...
      loadContent: function() {
        var e, b = this;
        "function" == typeof b.options.beforeInit && b.options.beforeInit.apply(this, [b.$elem]), "string" == typeof b.options.jsonPath ? (e = b.options.jsonPath, f.getJSON(e, function(a) {
          var d, e = "";
      ...
      updateItems: function() {
        ...
        if ((a = f(this.options.responsiveBaseWidth).width()) > (this.options.itemsDesktop[0] || this.orignalItems) && (this.options.items = this.orignalItems), !1 !== this.options.itemsCustom)
      ...
      appendItemsSizes: function() {
        ...
        a.$owlItems.each(function(c) {
          ...
          d.css({
            width: a.itemWidth
          }).data("owl-item", Number(c)), 0 != c % a.options.items && c !== e || e < c || (b += 1), d.data("owl-roundPages", b)
        })
      },
      ...
      loops: function() {
        var e, c, a = 0,
          b = 0;
        for (this.positionsInArray = [0], this.pagesInArray = [], e = 0; e < this.itemsAmount; e += 1) b += this.itemWidth, this.positionsInArray.push(-b), !0 === this.options.scrollPerPage && ((c = (c = f(this.$owlItems[e])).data("owl-roundPages")) !== a && (this.pagesInArray[a] = this.positionsInArray[e], a = c))
      },
      ...
      goTo: function(a, b, e) {
        var c = this;
        return !c.isTransition && ("function" == typeof c.options.beforeMove && c.options.beforeMove.apply(this, [c.$elem]), a >= c.maximumItem ? a = c.maximumItem : a <= 0 && (a = 0), c.currentItem = c.owl.currentItem = a, !1 !== c.options.transitionStyle && "drag" !== e && 1 === c.options.items && !0 === c.browser.support3d ? (c.swapSpeed(0), !0 === c.browser.support3d ? c.transition3d(c.positionsInArray[a]) : c.css2slide(c.positionsInArray[a], 1), c.afterGo(), c.singleItemTransition(), !1) : (a = c.positionsInArray[a], !0 === c.browser.support3d ? (!(c.isCss3Finish = !1) === b ? (c.swapSpeed("paginationSpeed"), g.setTimeout(function() {
          c.isCss3Finish = !0
      ...
      lazyLoad: function() {
        ...
        for (a = 0; a < this.itemsAmount; a += 1) "loaded" !== (b = f(this.$owlItems[a])).data("owl-loaded") && (e = b.data("owl-item"), "string" != typeof(c = b.find(".lazyOwl")).data("src") ? b.data("owl-loaded", "loaded") : (void 0 === b.data("owl-loaded") && (c.hide(), b.addClass("loading").data("owl-loaded", "checked")), (!0 !== this.options.lazyFollow || e >= this.currentItem) && e < this.currentItem + this.options.items && c.length && this.lazyPreload(b, c)))
      },
      ...
      addItem: function(a, b) {
        var e;
        return !!a && (0 === this.$elem.children().length ? (this.$elem.append(a), this.setVars(), !1) : (this.unWrap(), (e = void 0 === b || -1 === b ? -1 : b) >= this.$userItems.length || -1 === e ? this.$userItems.eq(-1).after(a) : this.$userItems.eq(e).before(a), void this.setVars()))
      },
      removeItem: function(a) {
        if (0 === this.$elem.children().length) return !1;
        a = void 0 === a || -1 === a ? -1 : a, this.unWrap(), this.$userItems.eq(a).remove(), this.setVars()
      }
    };
    ...
    a.MixItUp = function() {
      ...
      _refresh: function(a, c) {
        ...
        for (var e = 0; e < d._$targets.length; e++) {
          if ((f = d._$targets[e]).dataset === b || c) {
            f.dataset = {};
        ...
        if (d._$targets.length && a || !d._origOrder.length && d._$targets.length) {
          d._origOrder = [];
          for (e = 0; e < d._$targets.length; e++) {
            var f = d._$targets[e];
            d._origOrder.push(f)
          }
        }
      ...
      _processClick: function(c, d) {
        ...
        if (e._execAction("_processClick", 0, arguments), !e._mixing || e.animation.queue && e._queue.length < e.animation.queueLimit) {
          if (e._clicking = !0, "sort" === d) {
            ...
            (!c.hasClass(e.controls.activeClass) || -1 < g.indexOf("random")) && (a(e.selectors.sort).removeClass(e.controls.activeClass), f(c, d), e.sort(g))
          }
          if ("filter" === d) {
      ...
      _updateControls: function(c, d) {
        ...
        for (var j = 0; j < 2; j++)(i = e.controls.live ? a(e.selectors[h]) : e["_$" + h + "Buttons"]) && g(i, "[data-" + h + '="' + f[h] + '"]'), h = "sort";
      ...
      _compare: function(a, b, c) {
        ...
        return g < h ? "asc" === e ? -1 : 1 : h < g ? "asc" === e ? 1 : -1 : g === h && d._newSort.length > c + 1 ? d._compare(a, b, c + 1) : 0
      },
      ...
      _parseSort: function(a) {
        for (var c = "string" == typeof a ? a.split(" ") : [a], d = [], e = 0; e < c.length; e++) {
          var f = "string" == typeof a ? c[e].split(":") : ["custom", c[e]],
            g = {
              sortBy: this._helpers._camelCase(f[0]),
              order: f[1] || "asc"
            };
          if (d.push(g), "default" === g.sortBy || "random" === g.sortBy) break
        }
        return this._execFilter("_parseSort", d, arguments)
      },
      _parseEffects: function() {
        var a = this,
          ...
          c = function(b, c) {
            if (-1 < a.animation.effects.indexOf(b)) {
              if (c) {
      ...
      _getTargetData: function(a, b) {
        var c;
        a.dataset[b + "PosX"] = a.offsetLeft, a.dataset[b + "PosY"] = a.offsetTop, this.animation.animateResizeTargets && (c = window.getComputedStyle(a), a.dataset[b + "MarginBottom"] = parseInt(c.marginBottom), a.dataset[b + "MarginRight"] = parseInt(c.marginRight), a.dataset[b + "Width"] = a.offsetWidth, a.dataset[b + "Height"] = a.offsetHeight)
      },
      ...
      _prepTargets: function() {
        ...
        for (d = 0; d < b._$pre.length; d++) {
          e = b._$pre[d], f = a(e);
          var g_x = e.dataset.origPosX - e.dataset.interPosX,
            g_y = e.dataset.origPosY - e.dataset.interPosY;
          c = b._getPrefixedCSS("transform", "translate(" + g_x + "px," + g_y + "px)");
      ...
      _animateTargets: function() {
        ...
        for (c = 0; c < b._$toHide.length; c++) {
          d = b._$toHide[c], e = a(d), g = b._getDelay(c);
          var k = {};
          for (i = 0; i < 2; i++) {
            k[(j = 0 === i ? j = b._prefix : "") + "transition-delay"] = g + "ms", k[j + "transform"] = b.effects.transformOut, k.opacity = b.effects.opacity
          }
      ...
      _bindTargetDone: function(b) {
        ...
        c._execAction("_bindTargetDone", 0, arguments), d.dataset.bound || (d.dataset.bound = !0, c._targetsBound++, b.on("webkitTransitionEnd.mixItUp transitionend.mixItUp", function(e) {
          (-1 < e.originalEvent.propertyName.indexOf("transform") || -1 < e.originalEvent.propertyName.indexOf("opacity")) && a(e.originalEvent.target).is(c.selectors.target) && (b.off(".mixItUp"), delete d.dataset.bound, c._targetDone())
      ...
      _getPrefixedCSS: function(a, b, c) {
        var e = {};
        for (i = 0; i < 2; i++) {
          var f = 0 === i ? this._prefix : "";
          e[f + a] = c ? f + b : b
        }
        return this._execFilter("_getPrefixedCSS", e, arguments)
      },
      ...
      _parseMultiMixArgs: function(a) {
        ...
        return this._execFilter("_parseMultiMixArgs", c, arguments)
      },
      ...
      insert: function() {
        var a = this,
          ...
          d = document.createDocumentFragment(),
          e = (a._refresh(), a._$targets.length ? b.index < a._$targets.length || !a._$targets.length ? a._$targets[b.index] : a._$targets[a._$targets.length - 1].nextElementSibling : a._$parent[0].children[0]);
      ...
      getOption: function(a) {
        var c = this;
        return a ? c._execFilter("getOption", function(a, c) {
      ...
      return c = this.each(function() {
        if (d && "string" == typeof d[0]) {
          ...
          var d = new a.MixItUp;
          d._execAction("_instantiate", 0, arguments), b.id = b.id ? b.id : "MixItUp" + ("00000" + (16777216 * Math.random() << 0).toString(16)).substr(-6).toUpperCase(), d._instances[b.id] || (d._instances[b.id] = d)._init(b, c), d._execAction("_instantiate", 1, arguments)
        }(this, d[0])
      }), e.length ? 1 < e.length ? e : e[0] : c
          ...
          for (var h = 0; h < 4; h++) {
            switch (h) {
              case 0:
                ...
                break;
              case 1:
                i = a.MixItUp.prototype._helpers._camelCase(i);
                break;
              case 2:
                i = d + f[g];
                break;
              case 3:
                i = a.MixItUp.prototype._helpers._camelCase(d + f[g])
            }
            if (e.style[i] !== b && "unknown" != typeof e.style[i] && 0 < e.style[i].length && (e.style[i] = ""), !d && 1 === h) break
          }
  ...
  function() {
    ...
    ! function(t, e) {
      ...
      return i = n(r), c = 0 <= t.call(r, "ontouchstart"), s = {
        horizontal: {},
        vertical: {}
      }, a = {}, u = "waypoints-context-id", p = "resize.waypoints", y = "scroll.waypoints", v = f = 1, w = "waypoints-waypoint-ids", g = "waypoint", m = "waypoints", o = function() {
        function t(t) {
          var e = this;
        ...
        return t.prototype.doScroll = function() {
          ...
          return r = n.isWindow(this.element), e = this.$element.offset(), this.doScroll(), t = {
            ...
            return n.each(i.waypoints[t], function(t, r) {
              var i, o, l, s, f;
              if (i = r.options.offset, l = r.offset, o = n.isWindow(r.element) ? 0 : r.$element.offset()[e.offsetProp], n.isFunction(i) ? i = i.apply(r.element) : "string" == typeof i && (i = parseFloat(i), -1 < r.options.offset.indexOf("%") && (i = Math.ceil(e.contextDimension * i / 100))), r.offset = o - e.contextOffset + e.contextScroll - i, (!r.options.onlyOnScroll || null == l) && r.enabled) return null !== l && l < (s = e.oldScroll) && s <= r.offset ? r.trigger([e.backward]) : null !== l && l > (f = e.oldScroll) && f >= r.offset ? r.trigger([e.forward]) : null === l && e.oldScroll >= r.offset ? r.trigger([e.forward]) : void 0
            })
          })
        ...
        init: function(t, e) {
          return null == e && (e = {}), null == e.handler && (e.handler = t), this.each(function() {
            var t, r, i, s;
            return t = n(this), i = null != (s = e.context) ? s : n.fn[g].defaults.context, n.isWindow(i) || (i = t.closest(i)), i = n(i), (r = a[i.data(u)]) || (r = new o(i)), new l(t, r, e)
          }), n[m]("refresh"), this
        },
        disable: function() {
  ...
  function($) {
    ...
    $.fn.counterUp = function(options) {
      ...
      return this.each(function() {
        ...
        $this.waypoint(function() {
          ...
          num = num.replace(/,/g, "");
          /^[0-9]+$/.test(num);
          for (var isFloat = /^[0-9]+\.[0-9]+$/.test(num), decimalPlaces = isFloat ? (num.split(".")[1] || []).length : 0, i = divisions; 1 <= i; i--) {
          ...
          $this.data("counterup-func", function() {
            $this.text($this.data("counterup-nums").shift()), $this.data("counterup-nums").length ? setTimeout($this.data("counterup-func"), $settings.delay) : ($this.data("counterup-nums"), $this.data("counterup-nums", null), $this.data("counterup-func", null))
    ...
    $("#portfolio-contant-active").mixItUp(), $("#testimonial-slider").owlCarousel({
      paginationSpeed: 500,
      singleItem: !0,
      autoPlay: 3e3
      ...
      delay: 10,
      time: 1e3
    }), dustycanvas && function() {
      var displayWidth, displayHeight, wait, count, numToAddEachFrame, particleList, recycleBin, particleAlpha, fLen, m, projCenterX, projCenterY, zMax, turnAngle, turnSpeed, sphereRad, sphereCenterY, sphereCenterZ, particleRad, zeroAlphaDepth, randAccelX, randAccelY, randAccelZ, gravity, rgbString, nextParticle, sinAngle, cosAngle, rotX, rotZ, depthAlphaFactor, i, theta, phi, x0, y0, z0, introLeft = document.getElementById("intro-left"),
        introRight = document.getElementById("intro-right"),
        context = dustycanvas.getContext("2d"),
        TWOPI = 2 * Math.PI;

      function onTimer() {
        if (wait <= ++count)
          for (i = count = 0; i < numToAddEachFrame; i++) {
            theta = Math.random() * TWOPI, phi = Math.acos(2 * Math.random() - 1), x0 = sphereRad * Math.sin(phi) * Math.cos(theta), y0 = sphereRad * Math.sin(phi) * Math.sin(theta), z0 = sphereRad * Math.cos(phi);
            var p = addParticle(x0, sphereCenterY + y0, sphereCenterZ + z0, .002 * x0, .002 * y0, .002 * z0);
            p.attack = 50, p.hold = 0, p.decay = 300, p.initValue = 0, p.holdValue = particleAlpha, p.lastValue = 0, p.stuckTime = 70 + 20 * Math.random(), p.accelX = 0, p.accelY = gravity, p.accelZ = 0
          }
        for (turnAngle = (turnAngle + turnSpeed) % (2 * Math.PI), sinAngle = Math.sin(turnAngle), cosAngle = Math.cos(turnAngle), context.fillStyle = "#fff", context.fillRect(0, 0, displayWidth, displayHeight), p = particleList.first; null != p;) nextParticle = p.next, p.age++, p.age > p.stuckTime && (p.velX += p.accelX + randAccelX * (2 * Math.random() - 1), p.velY += p.accelY + randAccelY * (2 * Math.random() - 1), p.velZ += p.accelZ + randAccelZ * (2 * Math.random() - 1), p.x += p.velX, p.y += p.velY, p.z += p.velZ), rotX = cosAngle * p.x + sinAngle * (p.z - sphereCenterZ), rotZ = -sinAngle * p.x + cosAngle * (p.z - sphereCenterZ) + sphereCenterZ, m = fLen / (fLen - rotZ), p.projX = rotX * m + projCenterX, p.projY = p.y * m + projCenterY, p.age < p.attack + p.hold + p.decay ? p.age < p.attack ? p.alpha = (p.holdValue - p.initValue) / p.attack * p.age + p.initValue : p.age < p.attack + p.hold ? p.alpha = p.holdValue : p.age < p.attack + p.hold + p.decay && (p.alpha = (p.lastValue - p.holdValue) / p.decay * (p.age - p.attack - p.hold) + p.holdValue) : p.dead = !0, p.projX > displayWidth || p.projX < 0 || p.projY < 0 || p.projY > displayHeight || zMax < rotZ || p.dead ? recycle(p) : (depthAlphaFactor = 1 < (depthAlphaFactor = 1 - rotZ / zeroAlphaDepth) ? 1 : depthAlphaFactor < 0 ? 0 : depthAlphaFactor, context.fillStyle = rgbString + depthAlphaFactor * p.alpha + ")", context.beginPath(), context.arc(p.projX, p.projY, m * particleRad, 0, 2 * Math.PI, !1), context.closePath(), context.fill()), p = nextParticle
      }

      function addParticle(x0, y0, z0, vx0, vy0, vz0) {
        var newParticle;
        return null != recycleBin.first ? null != (newParticle = recycleBin.first).next ? (recycleBin.first = newParticle.next, newParticle.next.prev = null) : recycleBin.first = null : newParticle = {}, null == particleList.first ? ((particleList.first = newParticle).prev = null, newParticle.next = null) : (newParticle.next = particleList.first, particleList.first.prev = newParticle, (particleList.first = newParticle).prev = null), newParticle.x = x0, newParticle.y = y0, newParticle.z = z0, newParticle.velX = vx0, newParticle.velY = vy0, newParticle.velZ = vz0, newParticle.age = 0, newParticle.dead = !1, Math.random() < .5 ? newParticle.right = !0 : newParticle.right = !1, newParticle
      }

      function recycle(p) {
        particleList.first == p ? null != p.next ? (p.next.prev = null, particleList.first = p.next) : particleList.first = null : null == p.next ? p.prev.next = null : (p.prev.next = p.next, p.next.prev = p.prev), null == recycleBin.first ? ((recycleBin.first = p).prev = null, p.next = null) : (p.next = recycleBin.first, recycleBin.first.prev = p, (recycleBin.first = p).prev = null)
      }! function() {
        var blockstyle = getComputedStyle(introRight),
          width = parseInt(blockstyle.getPropertyValue("width"), 10);
        blockstyle = getComputedStyle(introLeft);
        var height = parseInt(blockstyle.getPropertyValue("height"), 10);
        dustycanvas.width = width, dustycanvas.height = height, count = (wait = 1) - 1, numToAddEachFrame = 8, rgbString = "rgba(112,77,191,", particleAlpha = .3, displayWidth = dustycanvas.width, displayHeight = dustycanvas.height, projCenterX = displayWidth / 2, projCenterY = displayHeight / 2, zMax = (fLen = 320) - 2, particleList = {}, recycleBin = {}, randAccelZ = randAccelY = randAccelX = .1, gravity = 0, particleRad = 3.5, sphereRad = .3 * dustycanvas.height, sphereCenterY = 0, sphereCenterZ = -30 - sphereRad, zeroAlphaDepth = -3e3, turnSpeed = 2 * Math.PI / 700, turnAngle = 0, setInterval(onTimer, 1e3 / 24)
      }()
    }()
  });
